...
function page_previous(id, form_id, form_view_count, form_view_max)
{
	...
	if(document.getElementById('paypal_total').style.display!="none")
	{
	var paypal_div = wdformjQuery("#paypal_total");
	var tbody = wdformjQuery("#"+form_id+"form_view"+(id+1));
	var form = wdformjQuery("#form"+form_id);
	var offset_div = paypal_div.offset();
	var offset_tbody = tbody.offset();
	var offset_form = form.offset();

		paypal_div.css({
		top: 0,
		left: offset_tbody.left + tbody.width()-85
		});
