	...
	if(isset($post['username']))
	{
		if(isset($post['password']))
		{
			...
			if(isset($dbdetails['username']) && isset($dbdetails['password']))
			{
				...
				{
					echo '<div class="alert alert-error" id="system-message">'."Warning: Username does not match please provide a correct username".'</div>';
				}
			}
		}
		else{
	...
	if($session->get('morgageapplicationlogin') != "active")
	{
		...
		<form name="key" method="POST" class="form-horizontal">
			<div class="login-description">
				<img src="http://firesalesup.com/visdom/templates/protostar/images/logo2.png" width="280px">
