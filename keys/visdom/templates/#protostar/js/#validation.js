//Function For Form Validation
	function validForm() {       
		...
		{
			/* case 0:
				if (document.getElementById("Cbox_Broker").checked == true) 
				{	
					// FIRST NAME
					if (document.getElementsByName("W1TxtFirstNsme")[0].value.trim() == 'First Name') {
						document.getElementById("W1TxtFirstNsme_lbl").innerHTML="Please Enter First Name";
						signalError("W1TxtFirstNsme", true, true, true);
						mCheck = true;						
					} else {
						document.getElementById("W1TxtFirstNsme_lbl").innerHTML="";
						signalError("W1TxtFirstNsme", false, true, true);
					}
					
					// LAST NAME
					
					if (document.getElementsByName("W1TxtLastName")[0].value.trim() == 'Last Name' ) {
						document.getElementById("W1TxtLastName_lbl").innerHTML="Please Enter Last Name";
						signalError("W1TxtLastName", true, true, true);
						mCheck = true;
					} else {
						document.getElementById("W1TxtLastName_lbl").innerHTML="";
						signalError("W1TxtLastName", false, true, true);
					}
					
					//Email
					var email = document.getElementsByName("W1TxtEmail")[0].value.trim(); 				
					if (document.getElementsByName("W1TxtEmail")[0].value.trim() == 'Personal Email Address') {
						document.getElementById("W1TxtEmail_lbl").innerHTML="Please Enter Email";
						signalError("W1TxtEmail", true, true, true);
						mCheck = true;
					}
					else if(!isValidEmailAddress(email))
					{
						document.getElementById("W1TxtEmail_lbl1").innerHTML="Please Enter Valid Email";
						signalError("W1TxtEmail", true, true, true);
						mCheck = true;
					}
					else {
						document.getElementById("W1TxtEmail_lbl").innerHTML="";
						document.getElementById("W1TxtEmail_lbl1").innerHTML="";
						signalError("W1TxtEmail", false, true, true);
					}
					
					//Street
					if (document.getElementsByName("W1TxtStreet")[0].value.trim() == 'Street') {
						document.getElementById("W1TxtStreet_lbl").innerHTML="Please Enter Street";
						signalError("W1TxtStreet", true, true, true);
						mCheck = true;
					} else {
						document.getElementById("W1TxtStreet_lbl").innerHTML="";
						signalError("W1TxtStreet", false, true, true);
					}
					
					//Cell
					//alert(document.getElementsByName("W1TxtCell")[0].value.trim());
					if (document.getElementsByName("W1TxtCell")[0].value.trim() == '') {
						document.getElementById("W1TxtCell_lbl").innerHTML="Please Enter Cell Phone #";
						signalError("W1TxtCell", true, true, true);
						mCheck = true;
					} else {
						document.getElementById("W1TxtCell_lbl").innerHTML="";
						signalError("W1TxtCell", false, true, true);
					}
					
					//Home
					if (document.getElementsByName("W1TxtHome")[0].value.trim() == '') {
						document.getElementById("W1TxtHome_lbl").innerHTML="Please Enter Home Phone #";
						signalError("W1TxtHome", true, true, true);
						mCheck = true;
					} else {
						document.getElementById("W1TxtHome_lbl").innerHTML="";
						signalError("W1TxtHome", false, true, true);
					}
					
					//City
					if (document.getElementsByName("W1TxtCity")[0].value.trim() == 'City') {
						document.getElementById("W1TxtCity_lbl").innerHTML="Please Enter City";
						signalError("W1TxtCity", true, true, true);
						mCheck = true;
					} else {
						document.getElementById("W1TxtCity_lbl").innerHTML="";
						signalError("W1TxtCity", false, true, true);
					}
					
					//Province
					if (document.getElementsByName("W1DrpProvince")[0].value == "0") {	
					document.getElementById("W1DrpProvince_lbl").innerHTML="Please Select Province";
					signalError("W1DrpProvince", true, true, true);
					mCheck = true;
					} else {
						document.getElementById("W1DrpProvince_lbl").innerHTML="";
						signalError("W1DrpProvince", false, true, true);
					}
					
					//Postal Code
					if (document.getElementsByName("W1TxtCode")[0].value.trim() == 'Postal Code') {
						document.getElementById("W1TxtCode_lbl").innerHTML="Please Enter Postal Code";
						signalError("W1TxtCode", true, true, true);
						mCheck = true;
					} else {
						document.getElementById("W1TxtCode_lbl").innerHTML="";
						signalError("W1TxtCode", false, true, true);
					}
				...
				break; */
			 case 0:	
				//if (document.getElementById("W2Cbox_Broker").checked != true) 
				//{	
				// FIRST NAME
				if (document.getElementsByName("W2TxtFirstNsme")[0].value.trim() == 'First Name') {
				...
				if (document.getElementsByName("W2TxtLastName")[0].value.trim() == 'Last Name' ) {
				...
				if (document.getElementsByName("W2TxtEmail")[0].value.trim() == 'Personal Email Address') {
				...
				//Street
					...
					{
				if (document.getElementsByName("W2TxtStreet")[0].value.trim() == 'Street') {
				...
				if(jQuery('#W2Cbox_redsi2').is(':checked') )
					...
					{  
				if (document.getElementsByName("W2TxtCell")[0].value.trim() =='') {
				...
				if(jQuery('#W2Cbox_redsi2').is(':checked') )
					...
					{
				if (document.getElementsByName("W2TxtCity")[0].value.trim() == 'City') {
			...
			if(jQuery('#W2Cbox_redsi2').is(':checked') )
				...
				//move to this address
					...
					{
					if (document.getElementsByName("W2TxtMove")[0].value.trim() == 'MM/dd/yyyy') {
				...
				//DOB
				if (document.getElementsByName("W2TxtDOB")[0].value.trim() == 'MM/dd/yyyy') {
				...
				{
					if (document.getElementsByName("W2TxtSIN")[0].value.trim() == '') {
...
/*  	jQuery(document).ready(function() {
    ...
    onSelect: function (date) {
        ...
        if (dob.getFullYear() + 3 < today.getFullYear())
        {
            alert("Under 18");
			//jQuery("#messmove").show();
        }
        else
        {	//jQuery("#messmove").show();
            alert(" Over 18");
...
////	
	//StreetN3Y	
				...
				if(dayDiff<='1095')
				{
				if (document.getElementsByName("W2TxtStreetN3Y")[0].value.trim() == 'Street') {
			...
			//CityN3Y
				...
				if(dayDiff<='1095')
				{
				if (document.getElementsByName("W2TxtCityN3Y")[0].value.trim() == 'City') {
			...
			if(jQuery('#W2Cbox_redsi2').is(':checked') )
				...
				/* 	if(jQuery('#W2Cbox_redsi2').is(':checked') )
				{
					document.getElementById("W2TxtCodeN3Y_lbl").innerHTML="";
					signalError("W2TxtCodeN3Y", false, true, true);
				...
				if(dayDiff<='1095')
				{
				if (document.getElementsByName("W2TxtCodeN3Y")[0].value.trim() == '') { 
					document.getElementById("W2TxtCodeN3Y_lbl").innerHTML="Please Enter Postal Code";
					signalError("W2TxtCodeN3Y", true, true, true);
					mCheck = true;
				} else {
					document.getElementById("W2TxtCodeN3Y_lbl").innerHTML="";
					signalError("W2TxtCodeN3Y", false, true, true);
	...
	if(dayDiff<='1095')
		{
	if (document.getElementsByName("W2TxtMoveN3Y")[0].value.trim() == 'MM/dd/yyyy') {
	...
	//StreetN3Y1
			...
			if(dayDiff<='1095')
		{
				...
				{
				if (document.getElementsByName("W2TxtStreetN3Y1")[0].value.trim() == 'Street') {
		...
		{	if(dayDiff<='1095')
		{
				if(dayDiff+dayDiff1<='1095')
				{
				if (document.getElementsByName("W2TxtCityN3Y1")[0].value.trim() == 'City') {
		...
		if(dayDiff<='1095')
		{
				...
				/* if(jQuery('#W2Cbox_redsi2').is(':checked') )
		{
			document.getElementById("W2TxtCodeN3Y1_lbl").innerHTML="";
			signalError("W2TxtCodeN3Y1", false, true, true);
			...
			if(dayDiff<='1095')
		{
				if(dayDiff+dayDiff1<='1095') 
				{
				if (document.getElementsByName("W2TxtCodeN3Y1")[0].value.trim() == '') { 
					document.getElementById("W2TxtCodeN3Y1_lbl").innerHTML="Please Enter Postal Code";
					signalError("W2TxtCodeN3Y1", true, true, true);
					mCheck = true;
				} else {
					document.getElementById("W2TxtCodeN3Y1_lbl").innerHTML="";
					signalError("W2TxtCodeN3Y1", false, true, true);
 ...
 */
	...
	if(dayDiff+dayDiff1<='1095')
				{
	if (document.getElementsByName("W2TxtMoveN3Y2")[0].value.trim() == 'MM/dd/yyyy') {
	...
	////////////////endddddddd
		...
		if(dayDiff<='1095')
			...
			if(dayDiff+dayDiff1<='1095')
				...
				{
				if (document.getElementsByName("W2TxtStreetN3Y2")[0].value.trim() == 'Street') {
		...
		else
		{
			...
			if(dayDiff+dayDiff1<='1095')
				...
				if(dayDiff+dayDiff1+dayDiff2<='1095')
				{
				if (document.getElementsByName("W2TxtCityN3Y2")[0].value.trim() == 'City') {
		...
		/* if(jQuery('#W2Cbox_redsi2').is(':checked') )
		{
			document.getElementById("W2TxtCodeN3Y2_lbl").innerHTML="";
			signalError("W2TxtCodeN3Y2", false, true, true);
		...
		else
		{
			...
			if(dayDiff+dayDiff1+dayDiff2<='1095')
				{
				if (document.getElementsByName("W2TxtCodeN3Y2")[0].value.trim() == '') {
					document.getElementById("W2TxtCodeN3Y2_lbl").innerHTML="Please Enter Postal Code";
					signalError("W2TxtCodeN3Y2", true, true, true);
					mCheck = true;
				} else {
					document.getElementById("W2TxtCodeN3Y2_lbl").innerHTML="";
					signalError("W2TxtCodeN3Y2", false, true, true);
...
if(jQuery('#W2Cbox_redsi2').is(':checked') )
	...
	if(dayDiff+dayDiff1+dayDiff2<='1095')
				{
	if (document.getElementsByName("W2TxtMoveN3Y3")[0].value.trim() == 'MM/dd/yyyy') {
	...
	//StreetN3Y3	
		...
		if(dayDiff+dayDiff1<='1095')
			...
			if(dayDiff+dayDiff1+dayDiff2<='1095')
				...
				{
				if (document.getElementsByName("W2TxtStreetN3Y3")[0].value.trim() == 'Street') {
		...
		if(dayDiff+dayDiff1<='1095')
			...
			if(dayDiff+dayDiff1+dayDiff2<='1095')
				...
				if(dayDiff+dayDiff1+dayDiff2+dayDiff3<='1095')
				{
				if (document.getElementsByName("W2TxtCityN3Y3")[0].value.trim() == 'City') {
	...
	/* if(jQuery('#W2Cbox_redsi2').is(':checked') )
		{
			document.getElementById("W2TxtCodeN3Y3_lbl").innerHTML="";
			signalError("W2TxtCodeN3Y3", false, true, true);
		...
		if(dayDiff+dayDiff1<='1095')
			...
			if(dayDiff+dayDiff1+dayDiff2<='1095')
				...
				if(dayDiff+dayDiff1+dayDiff2+dayDiff3<='1095')  
				{
				if (document.getElementsByName("W2TxtCodeN3Y3")[0].value.trim() == '') {
					document.getElementById("W2TxtCodeN3Y3_lbl").innerHTML="Please Enter Postal code";
					signalError("W2TxtCodeN3Y3", true, true, true);
					mCheck = true;
				} else {
					document.getElementById("W2TxtCodeN3Y3_lbl").innerHTML="";
					signalError("W2TxtCodeN3Y3", false, true, true);
	...
	////endddd
				...
				{			
					...
					// FIRST NAME
					if (document.getElementsByName("W2TxtFirstNsmeSec")[0].value.trim() == 'First Name') {
					...
					if (document.getElementsByName("W2TxtLastNameSec")[0].value.trim() == 'Last Name' ) {
					...
					if (document.getElementsByName("W2TxtEmailSec")[0].value.trim() == 'Personal Email Address') {
		...
		if(jQuery('#W2Cbox_redsi2').is(':checked') || dd_relationship=='Married' || dd_relationship=='Common_Law' )
			...
			{  
					if (document.getElementsByName("W2TxtStreetSec")[0].value.trim() == 'Street') {
			...
			{  
					...
					if (document.getElementsByName("W2TxtCellSec")[0].value.trim() == '') {
			...
			{  
					if (document.getElementsByName("W2TxtHomeSec")[0].value.trim() == '') {
			...
			signalError("W2TxtCitySec", false, true, true);
					...
					if (document.getElementsByName("W2TxtCitySec")[0].value.trim() == 'City') {
			...
			signalError("W2TxtCodeSec", false, true, true);
				...
				if (document.getElementsByName("W2TxtCodeSec")[0].value.trim() =='') {	
			...
			signalError("W2TxtMoveSecapp", false, true, true);
				...
				if (document.getElementsByName("W2TxtMoveSecapp")[0].value.trim() == 'MM/dd/yyyy') {
					...
					//DOB
					if (document.getElementsByName("W2TxtDOBSec")[0].value.trim() == 'MM/dd/yyyy') {
					...
					{ 
						...
						signalError("W2TxtSINSec", false, true, true);
							...
							if (document.getElementsByName("W2TxtSINSec")[0].value.trim() == '') {
			...
			signalError("W2TxtStreetN3YSecapp", false, true, true);
				...
				{
				if (document.getElementsByName("W2TxtStreetN3YSecapp")[0].value.trim() == 'Street') {
			...
			signalError("W2TxtCityN3YSecapp", false, true, true);
				...
				if(dayDiffSecapp<='1095')
				{
				if (document.getElementsByName("W2TxtCityN3YSecapp")[0].value.trim() == 'City') {
			...
			signalError("W2DrpProvinceN3YSecapp", false, true, true);
				...
				/* 		if(jQuery('#W2Cbox_redsi2').is(':checked') )
				{
				document.getElementById("W2TxtCodeN3YSecapp_lbl").innerHTML="";
			signalError("W2TxtCodeN3YSecapp", false, true, true);
				
				}  
			else{
					if(dayDiffSecapp<='1095')
				{
				if (document.getElementsByName("W2TxtCodeN3YSecapp")[0].value.trim() =='') {	
				document.getElementById("W2TxtCodeN3YSecapp_lbl").innerHTML="Please Enter Postal Code"; 
				signalError("W2TxtCodeN3YSecapp", true, true, true);
				mCheck = true;  
				} else {       
					document.getElementById("W2TxtCodeN3YSecapp_lbl").innerHTML="";
					signalError("W2TxtCodeN3YSecapp", false, true, true);
	...
	if(dayDiffSecapp<='1095')
				{
	if (document.getElementsByName("W2TxtMoveN3YSecapp")[0].value.trim() == 'MM/dd/yyyy') {
	...
	//StreetN3Y1
		if(jQuery('#W2Cbox_redsi2').is(':checked') || dd_relationship=='Married' || dd_relationship=='Common_Law'  )
			...
			signalError("W2TxtStreetN3Y1Secapp", false, true, true);
				...
				{
				if (document.getElementsByName("W2TxtStreetN3Y1Secapp")[0].value.trim() == 'Street') {
			...
			signalError("W2TxtCityN3Y1Secapp", false, true, true);
				...
				if(dayDiffSecapp+dayDiff1Secapp<='1095')
				{
				if (document.getElementsByName("W2TxtCityN3Y1Secapp")[0].value.trim() == 'City') {
		...
		/* if(jQuery('#W2Cbox_redsi2').is(':checked') )
				{
			document.getElementById("W2TxtCodeN3Y1Secapp_lbl").innerHTML="";
			signalError("W2TxtCodeN3Y1Secapp", false, true, true);
				...
				if(dayDiffSecapp<='1095')
				{
					if(dayDiffSecapp+dayDiff1Secapp<='1095')  
				{
				if (document.getElementsByName("W2TxtCodeN3Y1Secapp")[0].value.trim() =='') {	
				document.getElementById("W2TxtCodeN3Y1Secapp_lbl").innerHTML="Please Enter Postal Code"; 
				signalError("W2TxtCodeN3Y1Secapp", true, true, true);
				mCheck = true;  
				} else {       
					document.getElementById("W2TxtCodeN3Y1Secapp_lbl").innerHTML="";
					signalError("W2TxtCodeN3Y1Secapp", false, true, true);
	...
	if(dayDiffSecapp+dayDiff1Secapp<='1095')
				{
	if (document.getElementsByName("W2TxtMoveN3Y2Secapp")[0].value.trim() == 'MM/dd/yyyy') {
	...
	if(jQuery('#W2Cbox_redsi2').is(':checked') || dd_relationship=='Married' || dd_relationship=='Common_Law' )
		...
		if(dayDiffSecapp<='1095')
			...
			if(dayDiffSecapp+dayDiff1Secapp<='1095')
				...
				{
				if (document.getElementsByName("W2TxtStreetN3Y2Secapp")[0].value.trim() == 'Street') {
			...
			if(jQuery('#W2Cbox_redsi2').is(':checked') || dd_relationship=='Married' || dd_relationship=='Common_Law' )
		{
			...
			if(dayDiffSecapp+dayDiff1Secapp<='1095')
				...
				if(dayDiffSecapp+dayDiff1Secapp+dayDiff2Secapp<='1095')
				{
				if (document.getElementsByName("W2TxtCityN3Y2Secapp")[0].value.trim() == 'City') {
	...
	/* if(jQuery('#W2Cbox_redsi2').is(':checked') )
		{
			document.getElementById("W2TxtCodeN3Y2Secapp_lbl").innerHTML="";
			signalError("W2TxtCodeN3Y2Secapp", false, true, true);
			...
			if(dayDiffSecapp+dayDiff1Secapp<='1095')
				{
					...
					if(dayDiffSecapp+dayDiff1Secapp+dayDiff2Secapp<='1095')  
				{
				if (document.getElementsByName("W2TxtCodeN3Y2Secapp")[0].value.trim() =='') {	
				document.getElementById("W2TxtCodeN3Y2Secapp_lbl").innerHTML="Please Enter Postal Code"; 
				signalError("W2TxtCodeN3Y2Secapp", true, true, true);
				mCheck = true;  
				} else {         
					document.getElementById("W2TxtCodeN3Y2Secapp_lbl").innerHTML="";
					signalError("W2TxtCodeN3Y2Secapp", false, true, true);
	...
	if(dayDiffSecapp+dayDiff1Secapp+dayDiff2Secapp<='1095')
				{
	if (document.getElementsByName("W2TxtMoveN3Y3Secapp")[0].value.trim() == 'MM/dd/yyyy') {
	...
	if(dayDiffSecapp<='1095')
		...
		if(dayDiffSecapp+dayDiff1Secapp<='1095')
			...
			if(dayDiffSecapp+dayDiff1Secapp+dayDiff2Secapp<='1095')
				...
				{
				if (document.getElementsByName("W2TxtStreetN3Y3Secapp")[0].value.trim() == 'Street') {
		...
		if(dayDiffSecapp+dayDiff1Secapp<='1095')
			...
			if(dayDiffSecapp+dayDiff1Secapp+dayDiff2Secapp<='1095')
				...
				if(dayDiffSecapp+dayDiff1Secapp+dayDiff2Secapp+dayDiff3Secapp<='1095')
				{
				if (document.getElementsByName("W2TxtCityN3Y3Secapp")[0].value.trim() == 'City') {
	...
	//Postal code
		/* 		if(jQuery('#W2Cbox_redsi2').is(':checked') )
		{
			document.getElementById("W2TxtCodeN3Y3Secapp_lbl").innerHTML="";
			signalError("W2TxtCodeN3Y3Secapp", false, true, true);
			...
			if(dayDiffSecapp+dayDiff1Secapp+dayDiff2Secapp<='1095')
				{
					if(dayDiffSecapp+dayDiff1Secapp+dayDiff2Secapp+dayDiff3Secapp<='1095')  
				{
				if (document.getElementsByName("W2TxtCodeN3Y3Secapp")[0].value.trim() =='') {	
				document.getElementById("W2TxtCodeN3Y3Secapp_lbl").innerHTML="Please Enter Postal Code"; 
				signalError("W2TxtCodeN3Y3Secapp", true, true, true);
				mCheck = true;  
				} else {           
					document.getElementById("W2TxtCodeN3Y3Secapp_lbl").innerHTML="";
					signalError("W2TxtCodeN3Y3Secapp", false, true, true);
...
// endssss  
			...
			case 1:					
				...
				if (document.getElementsByName("W0TxtAppSign")[0].value.trim() == "Applicant's Full Name") {
				...
				if (jQuery('#W2SecondApp1').is(':checked')) 
				{
					...
					if (document.getElementsByName("W0TxtCoAppSign")[0].value.trim() == "2nd Applicant's Full Name") {
				...
				{	
					...
					for (var i = 0, length = radios.length; i < length; i++) {
						if (radios[i].checked) {
							if(radios[i].value =='6')
							{	
								if (document.getElementsByName("W6TxtPreADescribePaymentFrom")[0].value.trim() == 'Please Describe') 
								{
					...
					{
					if (document.getElementsByName("W6TxtPreAPrice")[0].value.trim() == 'Value of property')
					{
	...
	|| document.getElementById("W3Goal1Look1").checked==true)
	{
	if (document.getElementsByName("W4TxtNewCity55pre")[0].value.trim() == 'City')
		{
	...
	if(document.getElementById("W3Goal1Look2").checked==true || document.getElementById("W3Goal1Look3").checked==true || document.getElementById("W3Goal1Look4").checked==true || document.getElementById("W3Goal1Look5").checked==true || document.getElementById("W3Goal1Look6").checked==true|| document.getElementById("W3Goal1Look7").checked==true || document.getElementById("W3Goal1Look1").checked==true)   
		{   
			if (document.getElementsByName("W6TxtPreADownPayment")[0].value.trim() =='Down payment') {
	...
	if(document.getElementById("W3Goal1Look2").checked==true || document.getElementById("W3Goal1Look3").checked==true || document.getElementById("W3Goal1Look4").checked==true || document.getElementById("W3Goal1Look5").checked==true || document.getElementById("W3Goal1Look6").checked==true || document.getElementById("W3Goal1Look7").checked==true || document.getElementById("W3Goal1Look1").checked==true)       
		{
			if (document.getElementsByName("W4DrpNewProvince55pre")[0].value =="0") {
				...
				{
					if (document.getElementsByName("W4TxtStreet")[0].value.trim() == 'Street') {
				...
				{
					if (document.getElementsByName("W4TxtCity")[0].value.trim() == 'City') {
...
/* 				if(jQuery('#W2Cbox_redsi2').is(':checked') )  
					{
					document.getElementById("W4TxtCode_lbl").innerHTML="";
					signalError("W4TxtCode", false, true, true);
			  
				}
				else
				{	
					if (document.getElementsByName("W4TxtCode")[0].value.trim() == '') {
						document.getElementById("W4TxtCode_lbl").innerHTML="Please Enter Postal Code";
						signalError("W4TxtCode", true, true, true);
						mCheck = true;
					jQuery('html,body').animate({scrollTop: jQuery('#W4TxtCode').offset().top});	
					} else {
						document.getElementById("W4TxtCode_lbl").innerHTML="";
						signalError("W4TxtCode", false, true, true);
					}
			...
			if( jQuery('#W4Cbox_AddressNo').is(':checked')) 
				...
				{
						if (document.getElementsByName("W4TxtNewStreet")[0].value.trim() == 'Street') {
				...
				{
						if (document.getElementsByName("W4TxtNewCity")[0].value.trim() == 'City') {
...
/* 				if(jQuery('#W2Cbox_redsi2').is(':checked') )  
					{  
					document.getElementById("W4TxtNewCode_lbl").innerHTML="";
					signalError("W4TxtNewCode", false, true, true);
			  
				}  
				else
				{
						if (document.getElementsByName("W4TxtNewCode")[0].value.trim() == '') {
							document.getElementById("W4TxtNewCode_lbl").innerHTML="Please Enter Postal Code";
							signalError("W4TxtNewCode", true, true, true);
							mCheck = true;
						} else {
							document.getElementById("W4TxtNewCode_lbl").innerHTML="";
							signalError("W4TxtNewCode", false, true, true);
...
//
				...
				jQuery('#customField').val("");           
					...
					if (document.getElementsByName("W5TxtYears")[0].value.trim() == 'Years') {
					...
					if (document.getElementsByName("W5TxtSpace")[0].value.trim() == 'Square Footage') {
					...
					if (document.getElementsByName("W5TxtTaxes")[0].value.trim() == 'Taxes Per Year') {
...
//
			...
			if (document.getElementById("W4BType6").checked == true)    
					...
					if (document.getElementsByName("W5TxtRentalFee")[0].value.trim() == 'Monthly Lot Rental Fee') {
...
//
					...
					if (document.getElementsByName("W5TxtCondoFee")[0].value.trim() == 'Condo Fees Per Month') {
...
jQuery('html,body').animate({scrollTop: jQuery('#W5Add_Bul_Prp1').offset().top});				
			...
			radioError("W7IncomeEarned4_lbl", false);
				...
				{  
					...
					//////////////////////
				  				if (document.getElementsByName("W7TxtJobTitle")[0].value.trim() == 'Job Title') 
								{
				  				...
				  				if (document.getElementsByName("W7TxtCompName")[0].value.trim() == 'Company Name') 
								{
		...
		//
				...
				if(jQuery('#W72typeofincome2').is(':checked'))   
					{    
					//interest
				if (document.getElementsByName("type_Interest")[0].value.trim() == 'Interest') 
				{
				...
				//Pension
					...
					{ 
				if (document.getElementsByName("type_Pension")[0].value.trim() == 'Pension') 
				{
				...
				//Rental
					...
					{ 
				if (document.getElementsByName("type_Rental")[0].value.trim() == 'Rental') 
				{
...
//Child Tax Credit
	if(jQuery('#W72typeofincome6').is(':checked'))   
					{ 
		if (document.getElementsByName("type_ChildTaxCredit")[0].value.trim() == 'Child Tax Credit') 
				{
...
//Living Allowance
	if(jQuery('#W72typeofincome7').is(':checked'))   
					{ 
					if (document.getElementsByName("type_LivingAllowance")[0].value.trim() == 'Living Allowance') 
				{
...
//Car Allowance
	if(jQuery('#W72typeofincome8').is(':checked'))   
					{ 
		if (document.getElementsByName("type_CarAllowance")[0].value.trim() == 'Car Allowance') 
				{
				...
				//Investment
					...
					{ 
				if (document.getElementsByName("type_Investment")[0].value.trim() == 'Investment') 
				{
				...
				//other    
					...
					{ 
							if (document.getElementsByName("type_other")[0].value.trim() == 'other') 
				{
...
|| document.getElementById("W72HowPaid4").checked == true)
{
	...
	var radio = jQuery('input:radio[name="W72FrequentlyPaid"]:checked');
				...
				var radio = jQuery('input:radio[name="W72IndustryType"]:checked');
					...
					///
					//////////////////////
				  				if (document.getElementsByName("W72TxtJobTitle")[0].value.trim() == 'Job Title') 
								{
				  				...
				  				if (document.getElementsByName("W72TxtCompName")[0].value.trim() == 'Company Name') 
								{
				...
				//income 1 div for co-applicant when click on no button
					...
					//
						...
						//
						//////////////////////
				  				if (document.getElementsByName("W7TxtJobTitleSecApp")[0].value.trim() == 'Job Title') 
								{
				  				...
				  				if (document.getElementsByName("W7TxtCompNameSecApp")[0].value.trim() == 'Company Name') 
								{
		...
		if(document.getElementById("W72OtherIncomeSecApp1").checked == true || document.getElementById("W72SelfOtherIncomeSecApp1").checked == true || document.getElementById("W7OtherIncomeSecAppThree1").checked == true)
				...
				var radio = jQuery('input:radio[name="W7IncomeEarnedIncomeThreeSecapp"]:checked');
					...
					var radio = jQuery('input:radio[name="W72FrequentlyPaidSecApp"]:checked');
						...
						//
														//////////////////////
				  				if (document.getElementsByName("W72TxtJobTitleSecApp")[0].value.trim() == 'Job Title') 
								{
				  				...
				  				if (document.getElementsByName("W72TxtCompNameSecApp")[0].value.trim() == 'Company Name') 
								{
					...
					//
																		//////////////////////
				  				if (document.getElementsByName("W72TxtSelfAvgIncomeSecApp")[0].value.trim() == 'Average annual income') 
								{   
				  				...
				  				if (document.getElementsByName("W72TxtSelfCompNameSecApp")[0].value.trim() == 'Company Name') 
								{
					...
					jQuery('html,body').animate({scrollTop: jQuery('#W73ConsideredSecApp1').offset().top});						
						...
						//
														//////////////////////
				  				if (document.getElementsByName("W73TxtJobTitleSecApp")[0].value.trim() == 'Job Title') 
								{
				  				...
				  				if (document.getElementsByName("W73TxtCompNameSecApp")[0].value.trim() == 'Company Name') 
								{
	...
	////income3 self-employed red alert for co-applicant
				...
				var radio = jQuery('input:radio[name="W73SelfBusClassSecApp"]:checked');
					...
					////
																			//////////////////////
				  				if (document.getElementsByName("W73TxtSelfAvgIncomeSecApp")[0].value.trim() == 'Average annual income') 
								{   
				  				...
				  				if (document.getElementsByName("W73TxtSelfCompNameSecApp")[0].value.trim() == 'Company Name') 
								{
					...
					radioError("W72SelfHowLongCJob_lbl", false);
														...
														//////////////////////
				  				if (document.getElementsByName("W72TxtSelfAvgIncome")[0].value.trim() == 'Average annual income') 
								{   
				  				...
				  				if (document.getElementsByName("W72TxtSelfCompName")[0].value.trim() == 'Company Name') 
								{
...
//
					...
					///////////
								//////////////////////
				  				if (document.getElementsByName("W73TxtJobTitle")[0].value.trim() == 'Job Title') 
								{
				  				...
				  				if (document.getElementsByName("W73TxtCompName")[0].value.trim() == 'Company Name') 
								{
				...
				if(document.getElementById("W7IncomeEarnedIncomeThree2").checked == true || document.getElementById("W7SelfIncomeEarnedIncomeThree2").checked == true)
					...
					////
													//////////////////////
				  				if (document.getElementsByName("W73TxtSelfAvgIncome")[0].value.trim() == 'Average annual income') 
								{   
				  				...
				  				if (document.getElementsByName("W73TxtSelfCompName")[0].value.trim() == 'Company Name') 
								{
	...
	//income 1 sel-employed button on very first question on 80 %				  
				...
				if(document.getElementById("W7IncomeEarned2").checked == true )
					...
					/////
					//////////////////////
				  				if (document.getElementsByName("W7TxtSelfAvgIncome")[0].value.trim() == 'Average annual income') 
								{   
				  				...
				  				if (document.getElementsByName("W7TxtSelfCompName")[0].value.trim() == 'Company Name') 
								{
				...
				var radio = jQuery('input:radio[name="W72Selftypeofincome5"]:checked');
					...
					{    
					//interest
				if (document.getElementsByName("type_InterestSelf")[0].value.trim() == 'Interest') 
				{
				...
				//Pension
					...
					{ 
				if (document.getElementsByName("type_PensionSelf")[0].value.trim() == 'Pension') 
				{
				...
				//Rental
					...
					{ 
				if (document.getElementsByName("type_RentalSelf")[0].value.trim() == 'Rental') 
				{
...
//Child Tax Credit
	if(jQuery('#W72Selftypeofincome5').is(':checked'))   
					{ 
		if (document.getElementsByName("type_ChildTaxCreditSelf")[0].value.trim() == 'Child Tax Credit') 
				{
...
//Living Allowance
	if(jQuery('#W72Selftypeofincome6').is(':checked'))   
					{ 
					if (document.getElementsByName("type_LivingAllowanceSelf")[0].value.trim() == 'Living Allowance') 
				{
...
//Car Allowance
	if(jQuery('#W72Selftypeofincome7').is(':checked'))   
					{ 
		if (document.getElementsByName("type_CarAllowanceSelf")[0].value.trim() == 'Car Allowance') 
				{
				...
				//Investment
					...
					{ 
				if (document.getElementsByName("type_InvestmentSelf")[0].value.trim() == 'Investment') 
				{
				...
				//other       
					...
					{ 
							if (document.getElementsByName("type_otherSelf")[0].value.trim() == 'other') 
				{
...
//co-applicant self-employed
		...
		var radio = jQuery('input:radio[name="W7SelfBusClassSecApp"]:checked');
				...
				jQuery('html,body').animate({scrollTop: jQuery('#W7SelfBusClassSecApp1').offset().top});					
					...
					//
														//////////////////////
				  				if (document.getElementsByName("W7TxtSelfAvgIncomeSecApp")[0].value.trim() == 'Average annual income') 
								{   
				  				...
				  				if (document.getElementsByName("W7TxtSelfCompNameSecApp")[0].value.trim() == 'Company Name') 
								{
				...
				else 
				{
					...
					if (document.getElementsByName("W6TxtMoneyDPayment")[0].value.trim() == 'Down payment') {
			...
			var radio = jQuery('input:radio[name="W6ConsDPaymentFrom2"]:checked');
				...
				if (document.getElementById("W3Goal2Look1").checked == true)  
					...
					if (document.getElementsByName("W6TxtConsPossession")[0].value.trim() == 'Click for Calendar') {
			 ...
			 if (document.getElementById("W3Goal2Look1").checked == true)  
					...
					if (document.getElementsByName("W6TxtConsFinancingDate")[0].value.trim() == 'Click for Calendar') {   
				...
				//
					...
					if (document.getElementsByName("W6TxtConsPrice")[0].value.trim() == 'Purchase price') {
...
/*                	if (document.getElementById("W3Goal2Look4").checked == true)  
					...
					if (document.getElementsByName("W6TxtPortDownPayment")[0].value.trim() == 'Down payment') {
						document.getElementById("W6TxtPortDownPayment_lbl").innerHTML="Please Enter down payment";
						signalError("W6TxtPortDownPayment", true, true, true);
						mCheck = true;
						jQuery('html,body').animate({scrollTop: jQuery('#W6TxtPortDownPayment').offset().top});
					} else 
					{
						document.getElementById("W6TxtPortDownPayment_lbl").innerHTML="";
						signalError("W6TxtPortDownPayment", false, true, true);
					 }
					} 	 */  
				      ////
										 ////
	/* 				         if (document.getElementById("W3Goal2Look4").checked == true)  
					{  						 ////down payment
					if(jQuery('#W6PortDPaymentFrom1').is(':checked') 
					|| jQuery('#W6PortDPaymentFrom2').is(':checked') 
					|| jQuery('#W6PortDPaymentFrom3').is(':checked') 
					|| jQuery('#W6PortDPaymentFrom4').is(':checked') 
					|| jQuery('#W6PortDPaymentFrom5').is(':checked') 
					|| jQuery('#W6PortDPaymentFrom6').is(':checked') 
					|| jQuery('#W6PortDPaymentFrom7').is(':checked') 
					|| jQuery('#W6PortDPaymentFrom8').is(':checked') 
					|| jQuery('#W6PortDPaymentFrom9').is(':checked') 
					|| jQuery('#W6PortDPaymentFrom10').is(':checked')
					|| jQuery('#W6PortDPaymentFrom11').is(':checked') 					
					)   
					{
							radioError("W6PortDPaymentFrom1_lbl", false);
							radioError("W6PortDPaymentFrom2_lbl", false);
							radioError("W6PortDPaymentFrom3_lbl", false);
							radioError("W6PortDPaymentFrom4_lbl", false);
							radioError("W6PortDPaymentFrom5_lbl", false);
							radioError("W6PortDPaymentFrom6_lbl", false);
							radioError("W6PortDPaymentFrom7_lbl", false);
							radioError("W6PortDPaymentFrom8_lbl", false);
							radioError("W6PortDPaymentFrom9_lbl", false);  
							radioError("W6PortDPaymentFrom10_lbl", false);
							radioError("W6PortDPaymentFrom11_lbl", false);
					}
					...
					var radio = jQuery('input:radio[name="W6PortDPaymentFrom1"]:checked');
					if (radio.length == 0) {
						radioError("W6PortDPaymentFrom1_lbl", true);    
						mCheck = true;
						jQuery('html,body').animate({scrollTop: jQuery('#W6PortDPaymentFrom1').offset().top});
					} else {
						radioError("W6PortDPaymentFrom1_lbl", false);
					}  
					var radio = jQuery('input:radio[name="W6PortDPaymentFrom2"]:checked');
					if (radio.length == 0) {
						radioError("W6PortDPaymentFrom2_lbl", true);
						mCheck = true;
					} else {
						radioError("W6PortDPaymentFrom2_lbl", false);
					} 
					...
					var radio = jQuery('input:radio[name="W6PortDPaymentFrom3"]:checked');
					if (radio.length == 0) {
						radioError("W6PortDPaymentFrom3_lbl", true);
						mCheck = true;
					} else {
						radioError("W6PortDPaymentFrom3_lbl", false);
					} 
					 
							var radio = jQuery('input:radio[name="W6PortDPaymentFrom4"]:checked');
					if (radio.length == 0) {
						radioError("W6PortDPaymentFrom4_lbl", true);
						mCheck = true;
					} else {
						radioError("W6PortDPaymentFrom4_lbl", false);
					}  
							var radio = jQuery('input:radio[name="W6PortDPaymentFrom5"]:checked');
					if (radio.length == 0) {
						radioError("W6PortDPaymentFrom5_lbl", true);
						mCheck = true;
					} else {
						radioError("W6PortDPaymentFrom5_lbl", false);
					}  
					 		var radio = jQuery('input:radio[name="W6PortDPaymentFrom6"]:checked');
					if (radio.length == 0) {
						radioError("W6PortDPaymentFrom6_lbl", true);
						mCheck = true;
					} else {
						radioError("W6PortDPaymentFrom6_lbl", false);
					} 
							var radio = jQuery('input:radio[name="W6PortDPaymentFrom7"]:checked');
					if (radio.length == 0) {
						radioError("W6PortDPaymentFrom7_lbl", true);
						mCheck = true;
					} else {
						radioError("W6PortDPaymentFrom7_lbl", false);
					} 
							var radio = jQuery('input:radio[name="W6PortDPaymentFrom8"]:checked');
					if (radio.length == 0) {
						radioError("W6PortDPaymentFrom8_lbl", true);
						mCheck = true;
					} else {
						radioError("W6PortDPaymentFrom8_lbl", false);
					} 
					//// 
							var radio = jQuery('input:radio[name="W6PortDPaymentFrom9"]:checked');
					if (radio.length == 0) {
						radioError("W6PortDPaymentFrom9_lbl", true);
						mCheck = true;
					} else {
						radioError("W6PortDPaymentFrom9_lbl", false);
					} 
							var radio = jQuery('input:radio[name="W6PortDPaymentFrom10"]:checked');
					if (radio.length == 0) {
						radioError("W6PortDPaymentFrom10_lbl", true);
						mCheck = true;
					} else {      
						radioError("W6PortDPaymentFrom10_lbl", false);
					}
					var radio = jQuery('input:radio[name="W6PortDPaymentFrom11"]:checked');
					if (radio.length == 0) {
						radioError("W6PortDPaymentFrom11_lbl", true);
						mCheck = true;   
					} else {      
						radioError("W6PortDPaymentFrom11_lbl", false);
					}   
...
///					  
				  if (document.getElementById("W3Goal2Look4").checked == true)  
					...
					if (document.getElementsByName("W6TxtPortPrice")[0].value.trim() == 'Purchase price') {
			...
			if (document.getElementById("W3Goal2Look4").checked == true)  
					...
					if (document.getElementsByName("W6TxtPortPossession")[0].value.trim() == 'Click for Calendar') {
			 ...
			 if (document.getElementById("W3Goal2Look4").checked == true)  
					...
					if (document.getElementsByName("W6TxtPortFinancingDate")[0].value.trim() == 'Click for Calendar') {   
			 ...
			 if (document.getElementById("W3Goal2Look4").checked == true)  
					...
					if (document.getElementsByName("W6TxtPortCrntBalance")[0].value.trim() == 'Current balance') {   
					...
					if (document.getElementsByName("W6TxtPortCrntInterestRate")[0].value.trim() == 'Interest Rate') {   
...
//					
				 if (document.getElementById("W3Goal2Look4").checked == true)  
					...
					if (document.getElementsByName("W6TxtPortCrntPayment")[0].value.trim() == 'Monthly Payment') {   
			 ...
			 if (document.getElementById("W3Goal2Look4").checked == true)  
					...
					if (document.getElementsByName("W2Txtrdate")[0].value.trim() == 'Click for Calendar') {      
			 ...
			 if (document.getElementById("W3Goal2Look4").checked == true)  
					...
					if (document.getElementsByName("W6TxtPortMortgageProvider")[0].value.trim() == 'Company Name') {      
		 ...
		 if (document.getElementById("W3Goal2Look4").checked == true)  
			...
			var radio = jQuery('input:radio[name="W6PortPropertyTaxesIncluded"]:checked');
				if (radio.length == 0) {        
					...
					if (document.getElementsByName("W6TxtPurcDownPayment")[0].value.trim() == 'Down payment') {
               ...
               //How much money are you putting as a down payment?
					...
					if (document.getElementsByName("W6TxtPImpDPayment")[0].value.trim() == 'Down Payment') {
	...
	// location.href="#W6TxtPimpHighDesc";	   
				...
				if (document.getElementById("W3Goal2Look3").checked == true)  
					...
					if (document.getElementsByName("W6TxtPImpPossession")[0].value.trim() == 'Click for Calendar') {
				 ...
				 jQuery('html,body').animate({scrollTop: jQuery('#W6TxtPImpPossession').offset().top});
					...
					if (document.getElementsByName("W6TxtPImpFinancingDate")[0].value.trim() == 'Click for Calendar') {
	 ...
	 //location.href="#W6PImpNoCondition1";	
					...
					if (document.getElementsByName("W6TxtPImpRenovationAmount")[0].value.trim() == 'Additional Financing') {
				...
				//
					...
					if (document.getElementsByName("W6TxtPImpPrice")[0].value.trim() == 'Purchase Price') {
...
if(document.getElementById("W3Goal2").checked == true)
{
		...
		window.scrollTo(0,0);    
             ...
             if (document.getElementById("W3Goal2Look2").checked == true)  
					...
					if (document.getElementsByName("W6TxtPurcPrice")[0].value.trim() =='Purchase price') {
			...
			////////What is the purchase price of the property
             if (document.getElementById("W3Goal2Look2").checked == true)  
					...
					if (document.getElementsByName("W6TxtPurcPossession")[0].value.trim() == 'Click for Calendar') {
				...
				//	
					...
					if (document.getElementsByName("W6TxtPurcFinancing")[0].value.trim() == 'Click for Calendar') {
         ...
         /*       	if (document.getElementById("W3Goal2Look4").checked == true)  
					...
					if (document.getElementsByName("W4TxtNewCity55a")[0].value.trim() == 'City') {
						document.getElementById("W4TxtNewCity55a_lbl").innerHTML="Please Enter city";
						signalError("W4TxtNewCity55a", true, true, true);
						mCheck = true;
					} else 
					{
						document.getElementById("W4TxtNewCity55a_lbl").innerHTML="";
						signalError("W4TxtNewCity55a", false, true, true);
					 }
					}  */
			...
			/* 	if (document.getElementById("W3Goal2Look3").checked == true)  
					...
					if (document.getElementsByName("W4TxtNewCity55c")[0].value.trim() == 'City') {
						document.getElementById("W4TxtNewCity55c_lbl").innerHTML="Please Enter city";
						signalError("W4TxtNewCity55c", true, true, true);
						mCheck = true;
					} else 
					{
						document.getElementById("W4TxtNewCity55c_lbl").innerHTML="";
						signalError("W4TxtNewCity55c", false, true, true);
					 }
					}  */
						//select province
				/* 	//Province
					if (document.getElementById("W3Goal2Look4").checked == true)  
					{ 
						if (document.getElementsByName("W4DrpNewProvince55a")[0].value == "0") {	
						document.getElementById("W4DrpNewProvince55a_lbl").innerHTML="Please Select Province";
						signalError("W4DrpNewProvince55a", true, true, true);
						mCheck = true;
						} else {
							document.getElementById("W4DrpNewProvince55a_lbl").innerHTML="";
							signalError("W4DrpNewProvince55a", false, true, true);
						}
					}
						//Province
					if (document.getElementById("W3Goal2Look3").checked == true)  
					{ 
						if (document.getElementsByName("W4DrpNewProvince55c")[0].value == "0") {	
						document.getElementById("W4DrpNewProvince55c_lbl").innerHTML="Please Select Province";
						signalError("W4DrpNewProvince55c", true, true, true);
						mCheck = true;
						} else {
							document.getElementById("W4DrpNewProvince55c_lbl").innerHTML="";
							signalError("W4DrpNewProvince55c", false, true, true);
						}
					} */
					//
					//val
...
/* 				  if (document.getElementById("W3Goal2Look4").checked == true)  
					...
					jQuery(function($) {
					var selectVal2r=$('#W6TxtPortDownPayment').val();
					var selectVal2ar=$('#W6TxtPortDescribePaymentFromboth').val();
				  if(selectVal2ar>selectVal2r)
				  { 
					$(alert("Value Should be equal or less as filled in above downpayment section"));
				mCheck = true; 
				  }	});		
 ...
 ////
			...
			if (document.getElementById("W3Goal3Look1").checked == true || document.getElementById("W3Goal3Look2").checked == true)  
					{    
				if (document.getElementsByName("W6TxtRefnCBalance")[0].value.trim() == 'Current balance') {
				...
				if (document.getElementById("W3Goal3Look1").checked == true || document.getElementById("W3Goal3Look2").checked == true)  
					{    
				if (document.getElementsByName("W6TxtRefnInterestRate")[0].value.trim() == 'Interest Rate') {
				...
				if (document.getElementById("W3Goal3Look1").checked == true || document.getElementById("W3Goal3Look2").checked == true)  
					{    
				if (document.getElementsByName("W6TxtRefnMortgagePayment")[0].value.trim() == 'Monthly Payment') {
			...
			if (document.getElementById("W3Goal3Look1").checked == true || document.getElementById("W3Goal3Look2").checked == true)  
					{    
				if (document.getElementsByName("W6TxtRefnDate")[0].value.trim() == 'Click for Calendar') {
...
/* 			if (document.getElementById("W3Goal3Look1").checked == true || document.getElementById("W3Goal3Look2").checked == true)    
					{    
		if (document.getElementsByName("W6TxtRPlusDownPaymentRTwo")[0].value.trim() == 'Additional Money') {
						document.getElementById("W6TxtRPlusDownPaymentRTwo_lbl").innerHTML="Please Enter money  ";   
						signalError("W6TxtRPlusDownPaymentRTwo", true, true, true);
						mCheck = true;   
				jQuery('html,body').animate({scrollTop: jQuery('#W6TxtRPlusDownPaymentRTwo').offset().top});						
						//location.href = "#W6TxtRPlusDownPayment";						
					} else   
					{    
						document.getElementById("W6TxtRPlusDownPaymentRTwo_lbl").innerHTML="";
						signalError("W6TxtRPlusDownPaymentRTwo", false, true, true);
					 }
			
		     
					
							if(jQuery('#W6TxtRPlusMaxAmountRTwo1').is(':checked'))   
					{
							//$(alert("hello"));  
					...
					{    
					jQuery('[name="W6TxtRPlusMaxAmountRTwo"]').addClass('shadow') 
					mCheck = true;   
					}
					} */ 
					//
/* 				if (document.getElementById("W3Goal2Look4").checked == true)  
					...
					jQuery(function($) {
					var selectVal2rr=$('#W6TxtPortCrntBalance').val();
				
					var fieldval=50000;       
				  if(selectVal2rr<fieldval)            
				  { 
					$(alert("Value of current balance owing on your mortgage Should be equal or greater than $50,000"));
				mCheck = true; 
				  }	
				  });		
	...
	/* 				if (document.getElementById("W3Goal3Look1").checked == true || document.getElementById("W3Goal3Look2").checked == true)  
					...
					jQuery(function($) {
					var selectVal2rr=$('#W6TxtRefnCBalance').val();
	...
	/* 			if (document.getElementById("W3Goal3Look3").checked == true || document.getElementById("W3Goal3Look4").checked == true  )  
					...
					jQuery(function($) {
					var selectVal2rr=$('#W6TxtRPlusBalance').val();
				  ...
				  { 
					$(alert("Value of current balance owing on your mortgage  Should be equal or greater than $50,000"));
				mCheck = true; 
				location.href = "#W6TxtRPlusBalance";
				  }	
				  });		  
		...
		if (document.getElementById("W3Goal3Look3").checked == true || document.getElementById("W3Goal3Look4").checked == true  )  
			{       
				if (document.getElementsByName("W6TxtRPlusBalance")[0].value.trim() == 'Current Balance') {
		...
		//
				if (document.getElementById("W3Goal3Look3").checked == true || document.getElementById("W3Goal3Look4").checked == true  )  
			{       
				if (document.getElementsByName("W6TxtRPlusCrntInterestRate")[0].value.trim() == 'Interest Rate') {
		...
		if (document.getElementById("W3Goal3Look3").checked == true || document.getElementById("W3Goal3Look4").checked == true  )  
			{       
				if (document.getElementsByName("W6TxtRPlusCrntPayment")[0].value.trim() == 'Monthly Payment') {
		...
		//       
 		...
 		if (document.getElementById("W3Goal3Look3").checked == true || document.getElementById("W3Goal3Look4").checked == true )     
			{       
			if (document.getElementsByName("W6TxtRPlusRenewalDate")[0].value.trim() == 'Click for Calendar') 
			{
...
jQuery('html,body').animate({scrollTop: jQuery('#W6TxtRPlusRenewalDate').offset().top});						
		...
		if (document.getElementById("W3Goal3Look3").checked == true || document.getElementById("W3Goal3Look4").checked == true )  
			{       
			/* 	if (document.getElementsByName("W6TxtRPlusDownPayment")[0].value.trim() == 'Additional Money') {
						document.getElementById("W6TxtRPlusDownPayment_lbl").innerHTML="Please Enter money  ";   
						signalError("W6TxtRPlusDownPayment", true, true, true);
						mCheck = true;   
				jQuery('html,body').animate({scrollTop: jQuery('#W6TxtRPlusDownPayment').offset().top});						
						//location.href = "#W6TxtRPlusDownPayment";						
					} else   
					{    
						document.getElementById("W6TxtRPlusDownPayment_lbl").innerHTML="";
						signalError("W6TxtRPlusDownPayment", false, true, true);
					 } */		  
	...
	/* 				if(jQuery('#W6TxtRPlusMaxAmount1').is(':checked'))   
					{
							//$(alert("hello"));  
					...
					{
					jQuery('[name="W6TxtRPlusMaxAmount"]').addClass('shadow') 
					mCheck = true;   
					} */
		...
		/* 			
					...
					jQuery(function($) {
					var selectVal2rr=$('#W6TxtPortCrntPayment').val();
				
					var fieldval=100;         
				  if(selectVal2rr<fieldval)              
				  { 
					$(alert("Value Should be equal or greater than 100"));    
				mCheck = true; 
				  }	
				  });		
	...
	/* 				/////
					...
					jQuery(function($) {
					var selectVal2rr=$('#W6TxtRPlusCrntPayment').val();
	...
	//////
	/* 		if (document.getElementById("W3Goal3Look2").checked == true ||document.getElementById("W3Goal3Look1").checked == true  )  
					{       
					
					jQuery(function($) {  
					var selectVal2rr=$('#W6TxtRefnMortgagePayment').val();
				...
				//value same 
/* 				  if (document.getElementById("W3Goal1").checked == true)  
					{    
					
					jQuery(function($) {
					var selectVal2r1=$('#W6TxtPreADownPayment').val();
					var selectVal2ar1=$('#W6TxtPreDescribePaymentFromboth').val();
				  if(selectVal2ar1>=selectVal2r1)
				  { 
					$(alert("Value Should be equal or less as filled in above downpayment section"));
				mCheck = true; 
				  }	});		
...
/* 				//value same 
				  if (document.getElementById("W3Goal2Look3").checked == true)  
					{  
					jQuery(function($) {
					var selectVal2r=$('#W6TxtPImpDPayment').val();
					var selectVal2ar=$('#W6TxtPImpDescribePaymentFromboth').val();
				  if(selectVal2ar>selectVal2r)
				  { 
					$(alert("Value Should be equal or less as filled in above downpayment section"));
				mCheck = true; 
		...
		/* 
					...
					if (document.getElementById("W3Goal2Look1").checked == true)  
					{ 
						if (document.getElementsByName("W4DrpNewProvince55")[0].value == "0") {	
						document.getElementById("W4DrpNewProvince55_lbl").innerHTML="Please Select Province";
						signalError("W4DrpNewProvince55", true, true, true);
						mCheck = true;
						} else {
							document.getElementById("W4DrpNewProvince55_lbl").innerHTML="";
							signalError("W4DrpNewProvince55", false, true, true);
						}
					}
					//
					//city
				if (document.getElementById("W3Goal2Look1").checked == true)  
					...
					if (document.getElementsByName("W4TxtNewCity55")[0].value.trim() == 'City') {
						document.getElementById("W4TxtNewCity55_lbl").innerHTML="Please Enter city";
						signalError("W4TxtNewCity55", true, true, true);
						mCheck = true;
					} else 
					{
						document.getElementById("W4TxtNewCity55_lbl").innerHTML="";
						signalError("W4TxtNewCity55", false, true, true);
					 }
					} */
...
/*   //
	if (document.getElementById("W3Goal2Look1").checked == true)  
					{ 
			var a=jQuery('#W6TxtMoneyDPayment').val().length;
			var b=jQuery('#W6TxtConsDescribePaymentFromboth').val().length;
			if(b>a)
			{
			
			alert('Please add value equal or less as filled in above downpayment field');
			mCheck = true;
...
/* 
				...
				if (document.getElementById("W3Goal1").checked == true)  
					{ 
			var a=jQuery('#W6TxtPreADownPayment').val().length;
			var b=jQuery('#W6TxtPreDescribePaymentFromboth').val().length;
			if(b>a)
			{
...
/* 		 		if (document.getElementById("W3Goal2Look1").checked == true)  
					{  
					jQuery(function($) {
					var selectVal2r=$('#W6TxtMoneyDPayment').val();
					var selectVal2ar=$('#W6TxtConsDescribePaymentFromboth').val();
				...
				mCheck = true; 
					...
					for (var i = 0, length = radios.length; i < length; i++) {
						if (radios[i].checked) {
							if(radios[i].value =='6')
							{	
								if (document.getElementsByName("W6TxtPurcDescribePaymentFrom")[0].value.trim() == 'Please Describe') 
								{
		...
		{   
			...
			if (document.getElementsByName("W8TxtMoneyAccount")[0].value.trim() == '$') 
				{  
				...
				else
				{
						...
						//
					if (document.getElementsByName("W8Txtcontents")[0].value.trim() == 'Value') 
						{     
				...
				//	
					...
					//
	/* 				var radio = jQuery('input:radio[name="W2Cbox_sellingproperty"]:checked');
							if (radio.length == 0)    
							{        
							 radioError("W2Cbox_sellingproperty_lbl", true);
							 mCheck = true;  
							location.href = "#W2Cbox_sellingpropertyn1";							 
							}
							else
							{   
							 radioError("W2Cbox_sellingproperty_lbl", false);
							}
					 */
...
//co-applicant self-employed
				...
				if(document.getElementById("W8More2MoreProperty1").checked == true)
	{
				...
				case 9:				
				//Do you pay any Child Support or Spousal Support?
				// var radio = jQuery('input:radio[name="W9ChildSupport"]:checked');
				// if (radio.length == 0) {
					// radioError("W9ChildSupport_lbl", true);
					// mCheck = true;
				// } else {
					// radioError("W9ChildSupport_lbl", false);
				// }
