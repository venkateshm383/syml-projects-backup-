...
function validForm() {       
	...
	switch (curPos) 
	{
		...
		//Social Insurance Number
		if(jQuery('#W2Cbox_redsi1Sec').is(':checked') ||jQuery('#W2Cbox_redsi2Sec').is(':checked') ) 
		{ 
		...
		//co-applicant employee in employee
		if(document.getElementById("W2SecondApp1").checked == true)  
		{
			if(document.getElementById("W7CoIncomeEarnedIncomeOne1").checked == true)  
			{
		...
		//co-applicant employed in self-employed
		if(document.getElementById("W2SecondApp1").checked == true)
		{
			if(document.getElementById("W7CoIncomeEarnedIncomeOne2").checked == true)
			{
		...
		{    
		if (document.getElementsByName("W6TxtPreAPriceRefinance")[0].value == '') {
		document.getElementById("W6TxtPreAPriceRefinance_lbl").innerHTML="Please Enter value";   
		signalError("W6TxtPreAPriceRefinance", true, true, true);
		mCheck = true;
		} else 
		{    
		document.getElementById("W6TxtPreAPriceRefinance_lbl").innerHTML="";
		signalError("W6TxtPreAPriceRefinance", false, true, true);
		}
		}
		
		if (document.getElementById("W3Goal3Look3").checked == true || document.getElementById("W3Goal3Look4").checked == true)  
		{    
		if (document.getElementsByName("W6TxtPreAPriceRefinanceplus")[0].value == '') {
		document.getElementById("W6TxtPreAPriceRefinanceplus_lbl").innerHTML="Please Enter value";   
		signalError("W6TxtPreAPriceRefinanceplus", true, true, true);
		mCheck = true;
		} else 
		{    
		document.getElementById("W6TxtPreAPriceRefinanceplus_lbl").innerHTML="";
		signalError("W6TxtPreAPriceRefinanceplus", false, true, true);
		}
		}
		...
		var radio = jQuery('input:radio[name="additionalfunds"]:checked');  
		if (radio.length == 0) {      
		radioError("additionalfunds_lbl",true);    
		mCheck = true;     
		jQuery('html,body').animate({scrollTop: jQuery('#additionalfunds1').offset().top});				
		} else {     
		radioError("additionalfunds_lbl",false);
		window.scrollTo(0,0);  
		}

		}
		
		if (document.getElementById("W3Goal3Look3").checked == true && document.getElementById("additionalfunds1").checked == true )  
		{
		...
		if (document.getElementById("W3Goal3Look4").checked == true && document.getElementById("additionalfunds1").checked == true )  
		{
		...
		*/     
		...
		if(document.getElementById("W2SecondApp1").checked == true)  
		{
			if(document.getElementById("W7CoIncomeEarnedIncomeTwo1").checked == true)  
			{
				var radio = jQuery('input:radio[name="W7HowPaidSecApp"]:checked');
				if (radio.length == 0)    
				{        
		...
		//self-employed co-app
		//co-applicant self-employed in self-employed
		if(document.getElementById("W2SecondApp1").checked == true)
		{
			if(document.getElementById("W7CoIncomeEarnedIncomeTwo2").checked == true)
			{
				var radio = jQuery('input:radio[name="W7SelfBusClassSecApp"]:checked');
				if (radio.length == 0)    
				{        
