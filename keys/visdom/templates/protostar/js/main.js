var sval='0';
	...
	function setarray()
	{
		...
		stepArr = new Array("GeneralInfo","DisclosureInfo", "Objectives", "LoanDetails","LoanDetails2","EmploymentDetails","AssetDetails","finish");
	...
	function unsetarray()
	{
		...
		stepArr = new Array("GeneralInfo","DisclosureInfo", "Objectives", "PropertyA", "PropertyB","LoanDetails","LoanDetails2","EmploymentDetails","AssetDetails","finish");
		...
		if (curPos < tBox) {
			if (validForm()) {			
				...
				cPos();
  				//alert(curPos);	
			  jQuery.ajax({
                                           //url: 'http://198.72.106.11/visdom/components/com_mortgageapplication/views/mortgageapplication/tmpl/xml-rpc.php?pageid='+curPos,
					   url: 'https://webserv.visdom.ca/components/com_mortgageapplication/views/mortgageapplication/tmpl/xml-rpc.php?pageid='+curPos,
                                           type: 'post',
                                           dataType: 'json',
