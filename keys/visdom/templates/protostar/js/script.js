...
jQuery(document).ready(function() {
			...
			{  
				  ...
				  // {
					...
					// if(input.val().length !=0){
						...
						// input.removeClass('type_validation');
					// }
					// else{
						// input.addClass('watermark');
		...
		// var watermark = 'First Name';
		 ...
		 // }).focus(function(){
		  // if (jQuery(this).val() == watermark)
			// jQuery(this).val(''); jQuery(this).removeClass('watermark');
		 // });
		 ...
		 //////////////////////////////////////////
		  ...
		  ////jQuery('#W2TxtStreetN3Y').val(watermark7N3Y).addClass('watermark');
		 ...
		 //////////////////////////////////////////
		  ...
		  ////jQuery('#W2TxtStreetN3Y1').val(watermark7N3Y2).addClass('watermark');
		...
		// var watermark10atsec= 'MM/dd/yyyy';
		 ...
		 // if(firstval=="")
		 // {
			// jQuery('#W2TxtFirstNsme').val('');
			// jQuery('#W2TxtFirstNsme').addClass('');
		 // }
		 ...
		 ////jQuery('#W2TxtStreet').val(watermark22).addClass('watermark');
		 ...
		 // if(firstval=="")
		 // {
			// jQuery('#W2TxtStreet').val('');
			// jQuery('#W2TxtStreet').addClass('');
		 // }
		 ///////  
		 ...
		 // if(firstval=="")
		 // {
			// jQuery('#W2TxtCity').val('');
			// jQuery('#W2TxtCity').addClass('');
		 // }
		 	 //////////////////////////////////////////
		 ...
		 // if(firstval=="")
		 // {
			// jQuery('#W4TxtNewCity55b').val('');
			// jQuery('#W4TxtNewCity55b').addClass('');
		 // }
		 //
		 ...
		 // if(firstval=="")
		 // {
			// jQuery('#W4TxtNewCity55a').val('');
			// jQuery('#W4TxtNewCity55a').addClass('');
		 // }
		 //
		 ...
		 // if(firstval=="")
		 // {
			// jQuery('#W4TxtNewCity55c').val('');
			// jQuery('#W4TxtNewCity55c').addClass('');
		 // }
		 //
		 ...
		 // if(firstval=="")
		 // {
			// jQuery('#W4TxtNewCity55').val('');
			// jQuery('#W4TxtNewCity55').addClass('');
		 // }
		 //
		 ...
		 // if(firstval=="")
		 // {
			// jQuery('#W4TxtNewCity55pre').val();
			// jQuery('#W4TxtNewCity55pre').addClass('');
		 // }
		 //////////////////////////////////////////
		 ...
		 ////jQuery('#W2TxtFirstNsmeSec').val(watermark116).addClass('watermark');
		 ...
		 ////jQuery('#W2TxtMiddleNameSec').val(watermark117).addClass('watermark');
		 ...
		 ////jQuery('#W2TxtLastNameSec').val(watermark118).addClass('watermark');
		 ...
		 ////jQuery('#W2TxtEmailSec').val(watermark119).addClass('watermark');
		 ...
		 // if(firstval=="")
		 // {
			// jQuery('#W2TxtDOBSec').val('');
			// jQuery('#W2TxtDOBSec').addClass('');
		 // }
...
//////////////
		...
		jQuery('input[type="text"]').blur(function(){
			...
			{
				jQuery('input[type="text"]').addClass("watermark");
			}
			else
			{
				jQuery('input[type="text"]').removeClass("watermark");
			}
		});
