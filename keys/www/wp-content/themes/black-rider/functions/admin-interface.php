...
function inkthemes_optionsframework_options_page() {
    ...
    <div class="trail-notify">
        <h1><?php _e('Get Black Rider Theme PRO!','black-rider'); ?></h1>
        ...
        <a href="http://www.inkthemes.com/wp-themes/blackriders-wordpress-theme/" target="blank">Upgrade to Black Rider Theme PRO Now &rarr;','black-rider'); ?></a>
    </div>
    <div class="wrap" id="of_container">
        ...
        <form action="" enctype="multipart/form-data" id="ofform">
            <div id="header">
                <div class="logo">
                    <h2><?php echo $themename; ?><?php _e('Options','black-rider'); ?></h2>
                </div>
