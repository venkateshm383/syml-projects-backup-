...
public class CouchBaseOperation {
	...
	public static void main(String[] args) {
		System.out.println("data"+new CouchBaseOperation().getCouchBaseDataProposal("SelectRec_4406"));
	...
	public CouchbaseClient getConnectionToCouchBaseToGetProposal() {
		String url = null;
		String bucket = null;
		String pass = null;
		int maximumRetry = 0;
...
CouchbaseClient		client12=getConnectionToCouchBaseToGetProposal();
		String object=(String)client12.get(key);
...
public void  updateDataInCouchBase(String key, JSONObject editData){
	...
	public ArrayList<Applicants> getApplicants(String opportunityId){
		System.out.println("**************Inside Applicant***********************");
