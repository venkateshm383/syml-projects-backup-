		...
		try {
	      ...
	      conn.setHostnameVerifier(new HostnameVerifier() {
			...
			OutputStream os = conn.getOutputStream();
				...
				logger.error("Error occured while processing restcallTostagMail method "+e.getMessage());
				  } 		
		}
