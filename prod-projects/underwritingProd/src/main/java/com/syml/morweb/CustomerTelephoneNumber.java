 ...
 *       &lt;/sequence>
 *       &lt;attribute name="usage" type="{http://MSC.IntegrationService.Schemas.MorWEB.BDI.Request.1}typeTelephoneUsageType" />
...
@XmlRootElement(name = "CustomerTelephoneNumber")
public class CustomerTelephoneNumber {
    ...
    public CustomerTelephoneNumber(final String numberAsString) {
    	final ObjectFactory objectFactory = new ObjectFactory();
    	final TelephoneNumber telephoneNumber = objectFactory.createTelephoneNumber();
    	telephoneNumber.setPhoneNumber(numberAsString);
