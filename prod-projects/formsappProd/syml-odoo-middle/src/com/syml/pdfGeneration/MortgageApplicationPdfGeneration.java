...
public class MortgageApplicationPdfGeneration {
	...
	String path=	MortgageApplicationPdfGenerationMethod("Keon Raymond  ","No", "No", null, null, "Bianca Raymond  ", "");
	System.out.println("feild "+path);
	//new SendWithUsExample().sendDisclosuresToclientCompletedApp("Keon", "keonraymond25@gmail.com", "Bianca", "biancaraymond@live.com", null,path		);
	}
			...
			System.out.println("inside MortgageApplication Pdf generation method ....... MortgageApplicationPdfGeneration class");
				UUID uuid=UUID.randomUUID();
				 SimpleDateFormat format=new SimpleDateFormat("yyyy-MM-dd hh:mm:ss");
				 
				 
						  GregorianCalendar calendar=(GregorianCalendar) GregorianCalendar.getInstance();
		String file= "/home/bizruntime/Desktop/";
			...
			// String outputFileName= file+"Disclosure_" + applicantName +"_"+format.format(calendar.getTime())+".pdf";
				 ...
				 Properties prop = new Properties();
			 		try {
			 			...
			 			String[][] content1 = {{" Minimum Mortgage Value"," Maximum Mortgage Value", "    Referral Fee"},
			 		...
			 		PdfTableCreation.PdfTableCreationMethod(page1, cos, rect.getHeight()-70-line2, 20, content1);
