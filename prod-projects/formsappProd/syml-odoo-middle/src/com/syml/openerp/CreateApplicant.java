...
int propertyCounterLocal = GenericHelperClass.getPropertyCounter();
	...
	public void updateApplicantIfNotCanad(String applicantID,String mobilePhone,String relationshipStatus,Date date,boolean nonResident){
		openERPSession = gHelperClass.getOdooConnection();
		try {
			...
			FilterCollection applicantfilters = new FilterCollection();
			applicantfilters.add("id","=",applicantID);
			RowCollection partners = applicantAd.searchAndReadObject(applicantfilters, new String[]{"cell","dob","relationship_status","non_resident"});
...
public void assignOppertunity(int applicantId,int jobFiveYear,int incomeDcreased,int futureFamily,int buyNewVehicale,int lifeStyleChnage,int financialRiskLetter,int properrtyLessThanFiveyear,int leadId ){
	...
	applicantAd2.writeObject(TestRow, true);
...
public  void updateOpportunity(int leadId,String propertystyle,String propertytype,String propertyHeating,String propertyWater,String propertySewage,String propertygarage,String propertygaragesize,String yesno,String square_footage ){
	...
	if(propertygargageId==3){
		com.debortoliwines.openerp.api.RowCollection partners11 = applicantAd3.searchAndReadObject(filters11, new String[]{"property_style","property_type","apartment_style","heating","water","sewage","garage_type","outbuildings_value","lot_size","id"});
		...
		com.debortoliwines.openerp.api.RowCollection partners11 = applicantAd3.searchAndReadObject(filters11, new String[]{"property_style","property_type","apartment_style","heating","water","sewage","garage_type","garage_size","outbuildings_value","lot_size","id"});
