...
public class SubmitReferalForm2ServletD extends HttpServlet {
	...
	//	String uniId=req.getParameter("uniid");
		...
		ReferralPhoneNumber=(String) ses.getAttribute("phoneNumber");
	...
	*/
		...
		if(form1UniqueId.trim().equals(OldUniqueId.trim())){
			...
			dataStoreValue.put("Type_Lead","Type_lead");
			...
			if(code==1){
				...
				try {
					...
					jsonTableData.put("leadEmail", refEmail);

					jsonTableData.put("leadReferralName", form1Fname+" "+form1Lname);
					jsonTableData.put("leadReferralPhone", ReferralPhoneNumber);
					jsonTableData.put("leadReferralEmail", form1Email);
