	...
	protected void service(HttpServletRequest req, HttpServletResponse res)
		...
		try{
			...
			try{
				...
				log.debug("Crm Lead ID inside Page 4 "+ crmLeadId);
				ses.setAttribute("crmLeadId", crmLeadId);
			}catch(Exception e
					){
				log.error("errror in getting crmLead ID in page 4 ",e);
...
//CochBase
				...
				if(selectvalue.equalsIgnoreCase("Employed") && selectvalue!=null){
					...
					try{
					 monthsWorked = Integer.parseInt(monthsWorked1);
						 ...
						 log.error("Error occurs while checking employee work strategies"+e.getMessage());		
					}
					...
					employeeTotal = Integer.parseInt(employeeTotalMonths1);
						 ...
						 log.error("Error occurs while parsing employee working months"+e.getMessage());	
					}
	...
	dataStoreValue.put("Applicant-Historical11", monthsTotal11);
						...
						employeeTotal1 = Integer.parseInt(monthsTotal11);
							...
							log.error("Error occurs while parsing employee total working months"+e.getMessage());
						}
...
log.debug("afetr int");
							...
							try{
							 employeeTotal2=Integer.parseInt(monthsTotal21);
								...
								log.error("Error occurs while parsing employeetotal working months"+e.getMessage());	
							}
				    	 ...
				    	 income.Type="Self-Employed";
							...
							income.Months=selfemployemonthssum2;
						      ...
						      selfemployemonthssum2Integer = Integer.parseInt(selfemployemonthssum2);
									...
									log.error("Error occurs while parsing self-employee total working months"+e.getMessage());	
								}
				...
				employeeTotal = Integer.parseInt(employeeTotalMonths1);
					...
					if(employeeTotal<36 && employeeTotalMonths1!=null){
					 ...
					 employeeTotal1 = Integer.parseInt(monthsTotal11);
							...
							log.error("Error occurs while parsing prior employee working months"+e.getMessage());	
						}
						int monthsInteger1=0;
						try{
						 monthsInteger1 = Integer.parseInt(monthsum11);
						}catch(Exception e){
							log.error("Error occurs while parsing prior employee1 total working months"+e.getMessage());
						}
					...
					monthsInteger11 = Integer.parseInt(monthsum21);
								...
								log.error("Error occurs while parsing prior employee2 working months"+e.getMessage());	
							}
							//Bussiness created with MonthSelection
						 ...
						 employeeTotal2=Integer.parseInt(monthsTotal21);
									...
									log.error("Error occurs while parsing prior employee2 total working months"+e.getMessage());	
								}
							...
							if(employeeTotal2<36 && monthsTotal21!=null){
								...
								try{
								 monthsInteger3 = Integer.parseInt(months31);
									...
									log.error("Error occurs while parsing prior employee working detailes"+e.getMessage());	
								}
